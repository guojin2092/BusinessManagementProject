...
import com.infrastructure.manager.EditTextManager;
import com.infrastructure.manager.ThreadManager;
...
public abstract class BaseActivity extends FragmentActivity implements OnGestureListener, OnTouchListener {
	 ...
	 * 是否需要回调
	 */
	protected boolean needCallback = true;
	...
	/**
	 * 初始化变量方法，必须在子类onCreate方法内setContentView后调用
	 */
