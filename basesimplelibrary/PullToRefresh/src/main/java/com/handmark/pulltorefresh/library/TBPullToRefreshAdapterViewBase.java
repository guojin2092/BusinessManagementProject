 ...
 * Version: 1.0.0
 * Description：
 * Date：2016/7/18 12:33
 * Modification  History:
 * Why & What is modified:
 */
public abstract class TBPullToRefreshAdapterViewBase <T extends AbsListView> extends PullToRefreshBase<T> implements
        OnScrollListener {
    ...
    public TBPullToRefreshAdapterViewBase(Context context) {
        super(context);
        mRefreshableView.setOnScrollListener(this);
    }

    public TBPullToRefreshAdapterViewBase(Context context, AttributeSet attrs) {
        super(context, attrs);
        mRefreshableView.setOnScrollListener(this);
    }

    public TBPullToRefreshAdapterViewBase(Context context, Mode mode) {
        super(context, mode);
        mRefreshableView.setOnScrollListener(this);
    }

    public TBPullToRefreshAdapterViewBase(Context context, Mode mode, AnimationStyle animStyle) {
    ...
    protected boolean isReadyForPullEnd() {
        ...
        if (lastVisiblePosition >= mRefreshableView.getChildCount()-1) {
    ...
    private int[] getNestedScrollConsumed(){
        ...
        try {
            Field field = ListView.class.getDeclaredField("mScrollConsumed");
            if(field != null){
