...
/** 
 * DAO for table "COMPANY_DELETE_INFO".
*/
public class CompanyDeleteInfoDao extends AbstractDao<CompanyDeleteInfo, Long> {

    public static final String TABLENAME = "COMPANY_DELETE_INFO";

    /**
     * Properties of entity CompanyDeleteInfo.<br/>
    ...
    public CompanyDeleteInfoDao(DaoConfig config) {
        super(config);
    }
    
    public CompanyDeleteInfoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"COMPANY_DELETE_INFO\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"COMPANY_DELETE_INFO\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, CompanyDeleteInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, CompanyDeleteInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    public CompanyDeleteInfo readEntity(Cursor cursor, int offset) {
        CompanyDeleteInfo entity = new CompanyDeleteInfo( //
    ...
    @Override
    public void readEntity(Cursor cursor, CompanyDeleteInfo entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(CompanyDeleteInfo entity, long rowId) {
        entity.setLocalId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(CompanyDeleteInfo entity) {
        if(entity != null) {
    ...
    @Override
    public boolean hasKey(CompanyDeleteInfo entity) {
