...
/** 
 * DAO for table "COMPANY_CONTACT_INFO".
*/
public class CompanyContactInfoDao extends AbstractDao<CompanyContactInfo, Long> {

    public static final String TABLENAME = "COMPANY_CONTACT_INFO";

    /**
     * Properties of entity CompanyContactInfo.<br/>
    ...
    public CompanyContactInfoDao(DaoConfig config) {
        super(config);
    }
    
    public CompanyContactInfoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"COMPANY_CONTACT_INFO\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"COMPANY_CONTACT_INFO\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, CompanyContactInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, CompanyContactInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    public CompanyContactInfo readEntity(Cursor cursor, int offset) {
        CompanyContactInfo entity = new CompanyContactInfo( //
    ...
    @Override
    public void readEntity(Cursor cursor, CompanyContactInfo entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(CompanyContactInfo entity, long rowId) {
        entity.setLocalId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(CompanyContactInfo entity) {
        if(entity != null) {
    ...
    @Override
    public boolean hasKey(CompanyContactInfo entity) {
