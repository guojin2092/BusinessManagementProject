...
/** 
 * DAO for table "COMPANY_USER_DELETE_INFO_BEAN".
*/
public class CompanyUserDeleteInfoBeanDao extends AbstractDao<CompanyUserDeleteInfoBean, Long> {

    public static final String TABLENAME = "COMPANY_USER_DELETE_INFO_BEAN";

    /**
     * Properties of entity CompanyUserDeleteInfoBean.<br/>
    ...
    public CompanyUserDeleteInfoBeanDao(DaoConfig config) {
        super(config);
    }
    
    public CompanyUserDeleteInfoBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"COMPANY_USER_DELETE_INFO_BEAN\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"COMPANY_USER_DELETE_INFO_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, CompanyUserDeleteInfoBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, CompanyUserDeleteInfoBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public CompanyUserDeleteInfoBean readEntity(Cursor cursor, int offset) {
        CompanyUserDeleteInfoBean entity = new CompanyUserDeleteInfoBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, CompanyUserDeleteInfoBean entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(CompanyUserDeleteInfoBean entity, long rowId) {
        entity.setLocalId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(CompanyUserDeleteInfoBean entity) {
        if(entity != null) {
    ...
    @Override
    public boolean hasKey(CompanyUserDeleteInfoBean entity) {
