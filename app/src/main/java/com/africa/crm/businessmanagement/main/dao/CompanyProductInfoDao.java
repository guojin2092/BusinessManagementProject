...
/** 
 * DAO for table "COMPANY_PRODUCT_INFO".
*/
public class CompanyProductInfoDao extends AbstractDao<CompanyProductInfo, Long> {

    public static final String TABLENAME = "COMPANY_PRODUCT_INFO";

    /**
     * Properties of entity CompanyProductInfo.<br/>
    ...
    public CompanyProductInfoDao(DaoConfig config) {
        super(config);
    }
    
    public CompanyProductInfoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"COMPANY_PRODUCT_INFO\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"COMPANY_PRODUCT_INFO\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, CompanyProductInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, CompanyProductInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    public CompanyProductInfo readEntity(Cursor cursor, int offset) {
        CompanyProductInfo entity = new CompanyProductInfo( //
    ...
    @Override
    public void readEntity(Cursor cursor, CompanyProductInfo entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(CompanyProductInfo entity, long rowId) {
        entity.setLocalId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(CompanyProductInfo entity) {
        if(entity != null) {
    ...
    @Override
    public boolean hasKey(CompanyProductInfo entity) {
