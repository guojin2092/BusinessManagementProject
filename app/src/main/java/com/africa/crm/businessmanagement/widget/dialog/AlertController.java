...
package com.africa.crm.businessmanagement.widget.dialog;
...
class AlertController {
    ...
    private boolean mCheckedLeft = true;
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        final TypedArray a = context.obtainStyledAttributes(null, R.styleable.MyAlertDialog,
                R.attr.alertDialogStyle, 0);
        mAlertDialogLayout = a.getResourceId(R.styleable.MyAlertDialog_android_layout, 0);
        mButtonPanelSideLayout = a.getResourceId(R.styleable.MyAlertDialog_buttonPanelSideLayout, 0);

        mListLayout = a.getResourceId(R.styleable.MyAlertDialog_listLayout, 0);
        mMultiChoiceItemLayout = a.getResourceId(R.styleable.MyAlertDialog_multiChoiceItemLayout, 0);
        mSingleChoiceItemLayout = a
                .getResourceId(R.styleable.MyAlertDialog_singleChoiceItemLayout, 0);
        mListItemLayout = a.getResourceId(R.styleable.MyAlertDialog_listItemLayout, 0);
        mShowTitle = a.getBoolean(R.styleable.MyAlertDialog_showTitle, true);
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attrs) {
            ...
            final TypedArray ta = context.obtainStyledAttributes(
                    attrs, R.styleable.MyRecycleListView);
            mPaddingBottomNoButtons = ta.getDimensionPixelOffset(
                    R.styleable.MyRecycleListView_paddingBottomNoButtons, -1);
            mPaddingTopNoTitle = ta.getDimensionPixelOffset(
                    R.styleable.MyRecycleListView_paddingTopNoTitle, -1);
            ta.recycle();
        }
    ...
    public static class AlertParams {
        ...
        public boolean mCheckedLeft = true;
        ...
        public void apply(AlertController dialog) {
            ...
            if (mMessage != null) {
                dialog.setMessage(mMessage, mMsgGravity);
            }
        ...
        private void createListView(final AlertController dialog) {
            ...
            if (mIsMultiChoice) {
                ...
                if (mIsSingleChoice) {
                    if (mCheckedLeft) {
                        ...
                        layout = R.layout.select_dialog_singlechoice_right;
                    }
                } else {
            ...
            dialog.mCheckedLeft=mCheckedLeft;
