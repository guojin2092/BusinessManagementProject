...
/** 
 * DAO for table "COMPANY_TASK_INFO".
*/
public class CompanyTaskInfoDao extends AbstractDao<CompanyTaskInfo, Long> {

    public static final String TABLENAME = "COMPANY_TASK_INFO";

    /**
     * Properties of entity CompanyTaskInfo.<br/>
    ...
    public CompanyTaskInfoDao(DaoConfig config) {
        super(config);
    }
    
    public CompanyTaskInfoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"COMPANY_TASK_INFO\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"COMPANY_TASK_INFO\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, CompanyTaskInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, CompanyTaskInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    public CompanyTaskInfo readEntity(Cursor cursor, int offset) {
        CompanyTaskInfo entity = new CompanyTaskInfo( //
    ...
    @Override
    public void readEntity(Cursor cursor, CompanyTaskInfo entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(CompanyTaskInfo entity, long rowId) {
        entity.setLocalId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(CompanyTaskInfo entity) {
        if(entity != null) {
    ...
    @Override
    public boolean hasKey(CompanyTaskInfo entity) {
