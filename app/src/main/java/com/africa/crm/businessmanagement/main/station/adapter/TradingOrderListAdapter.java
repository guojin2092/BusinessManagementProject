 ...
 */
public class TradingOrderListAdapter extends BaseQuickAdapter<TradingOrderInfoBean, BaseViewHolder> {
    private boolean mIsDeleted = false;

    public TradingOrderListAdapter(@Nullable List<TradingOrderInfoBean> data) {
