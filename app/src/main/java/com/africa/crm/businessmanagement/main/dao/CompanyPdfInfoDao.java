...
/** 
 * DAO for table "COMPANY_PDF_INFO".
*/
public class CompanyPdfInfoDao extends AbstractDao<CompanyPdfInfo, Long> {

    public static final String TABLENAME = "COMPANY_PDF_INFO";

    /**
     * Properties of entity CompanyPdfInfo.<br/>
    ...
    public CompanyPdfInfoDao(DaoConfig config) {
        super(config);
    }
    
    public CompanyPdfInfoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"COMPANY_PDF_INFO\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"COMPANY_PDF_INFO\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, CompanyPdfInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, CompanyPdfInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    public CompanyPdfInfo readEntity(Cursor cursor, int offset) {
        CompanyPdfInfo entity = new CompanyPdfInfo( //
    ...
    @Override
    public void readEntity(Cursor cursor, CompanyPdfInfo entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(CompanyPdfInfo entity, long rowId) {
        entity.setLocalId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(CompanyPdfInfo entity) {
        if(entity != null) {
    ...
    @Override
    public boolean hasKey(CompanyPdfInfo entity) {
