...
/** 
 * DAO for table "COMPANY_DELETE_TRADING_ORDER_INFO".
*/
public class CompanyDeleteTradingOrderInfoDao extends AbstractDao<CompanyDeleteTradingOrderInfo, Long> {

    public static final String TABLENAME = "COMPANY_DELETE_TRADING_ORDER_INFO";

    /**
     * Properties of entity CompanyDeleteTradingOrderInfo.<br/>
    ...
    public CompanyDeleteTradingOrderInfoDao(DaoConfig config) {
        super(config);
    }
    
    public CompanyDeleteTradingOrderInfoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"COMPANY_DELETE_TRADING_ORDER_INFO\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"COMPANY_DELETE_TRADING_ORDER_INFO\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, CompanyDeleteTradingOrderInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, CompanyDeleteTradingOrderInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    public CompanyDeleteTradingOrderInfo readEntity(Cursor cursor, int offset) {
        CompanyDeleteTradingOrderInfo entity = new CompanyDeleteTradingOrderInfo( //
    ...
    @Override
    public void readEntity(Cursor cursor, CompanyDeleteTradingOrderInfo entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(CompanyDeleteTradingOrderInfo entity, long rowId) {
        entity.setLocalId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(CompanyDeleteTradingOrderInfo entity) {
        if(entity != null) {
    ...
    @Override
    public boolean hasKey(CompanyDeleteTradingOrderInfo entity) {
