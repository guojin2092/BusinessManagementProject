...
public class PaymentDetailActivity extends BaseActivity {
     ...
     * @param activity
     */
    public static void startActivity(Activity activity, PaymentInfoBean paymentInfoBean) {
        Intent intent = new Intent(activity, PaymentDetailActivity.class);
        intent.putExtra("info", paymentInfoBean);
    ...
    public void initView() {
        mPaymentInfoBean = (PaymentInfoBean) getIntent().getSerializableExtra("info");
        if (mPaymentInfoBean != null) {
            titlebar_name.setText(mPaymentInfoBean.getUserName());
        }
