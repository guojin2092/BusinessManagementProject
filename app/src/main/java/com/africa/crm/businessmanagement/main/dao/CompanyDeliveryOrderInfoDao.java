...
/** 
 * DAO for table "COMPANY_DELIVERY_ORDER_INFO".
*/
public class CompanyDeliveryOrderInfoDao extends AbstractDao<CompanyDeliveryOrderInfo, Long> {

    public static final String TABLENAME = "COMPANY_DELIVERY_ORDER_INFO";

    /**
     * Properties of entity CompanyDeliveryOrderInfo.<br/>
    ...
    public CompanyDeliveryOrderInfoDao(DaoConfig config) {
        super(config);
    }
    
    public CompanyDeliveryOrderInfoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"COMPANY_DELIVERY_ORDER_INFO\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"COMPANY_DELIVERY_ORDER_INFO\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, CompanyDeliveryOrderInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, CompanyDeliveryOrderInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    public CompanyDeliveryOrderInfo readEntity(Cursor cursor, int offset) {
        CompanyDeliveryOrderInfo entity = new CompanyDeliveryOrderInfo( //
    ...
    @Override
    public void readEntity(Cursor cursor, CompanyDeliveryOrderInfo entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(CompanyDeliveryOrderInfo entity, long rowId) {
        entity.setLocalId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(CompanyDeliveryOrderInfo entity) {
        if(entity != null) {
    ...
    @Override
    public boolean hasKey(CompanyDeliveryOrderInfo entity) {
