 ...
 */
public class SupplierListAdapter extends BaseQuickAdapter<EnterpriseInfoBean, BaseViewHolder> {
    private boolean mIsDeleted = false;

    public SupplierListAdapter(@Nullable List<EnterpriseInfoBean> data) {
        super(R.layout.item_supplier_list, data);
    }
