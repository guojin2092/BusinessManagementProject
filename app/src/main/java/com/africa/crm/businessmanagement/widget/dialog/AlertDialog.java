...
public class AlertDialog extends AppCompatDialog implements DialogInterface {
    ...
    public void setMessage(CharSequence message, int gravity) {
        mAlert.setMessage(message, gravity);
    }
    ...
    public static class Builder {
        ...
        public Builder setMessage(@StringRes int messageId, int gravity) {
            return setMessage(P.mContext.getText(messageId), gravity);
        }
        ...
        public Builder setMessage(@Nullable CharSequence message) {
            return setMessage(message, Gravity.CENTER);
        }

        public Builder setMessage(@Nullable CharSequence message, int gravity) {
            P.mMessage = message;
            P.mMsgGravity = gravity;
            return this;
        }
        ...
        public Builder setSingleChoiceItems(CharSequence[] items, int checkedItem, final OnClickListener listener) {
            ...
            return setSingleChoiceItems(true, items, checkedItem, listener);
        }


        public Builder setSingleChoiceItems(boolean left, CharSequence[] items, int checkedItem, final OnClickListener listener) {
            P.mCheckedLeft = left;
            P.mItems = items;
            P.mOnClickListener = listener;
            P.mCheckedItem = checkedItem;
