...
public class DaoSession extends AbstractDaoSession {
    ...
    private final DaoConfig companyExpenditureInfoDaoConfig;
    private final DaoConfig companyExpenditureInfoBDaoConfig;
    private final DaoConfig companyInfoDaoConfig;
    private final DaoConfig companyInventoryInfoDaoConfig;
    private final DaoConfig companyPackagingDataInfoDaoConfig;
    ...
    private final DaoConfig companyUserInfoBeanDaoConfig;
    ...
    private final DaoConfig companyUserDeleteInfoBeanDaoConfig;
    private final DaoConfig dicInfoDaoConfig;
    private final DaoConfig payRecordInfoDaoConfig;
    private final DaoConfig roleInfoBeanDaoConfig;
    ...
    private final CompanyExpenditureInfoDao companyExpenditureInfoDao;
    private final CompanyExpenditureInfoBDao companyExpenditureInfoBDao;
    private final CompanyInfoDao companyInfoDao;
    private final CompanyInventoryInfoDao companyInventoryInfoDao;
    private final CompanyPackagingDataInfoDao companyPackagingDataInfoDao;
    ...
    private final CompanyUserInfoBeanDao companyUserInfoBeanDao;
    ...
    private final CompanyUserDeleteInfoBeanDao companyUserDeleteInfoBeanDao;
    private final DicInfoDao dicInfoDao;
    private final PayRecordInfoDao payRecordInfoDao;
    private final RoleInfoBeanDao roleInfoBeanDao;
    ...
    public DaoSession(Database db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        companyExpenditureInfoDaoConfig = daoConfigMap.get(CompanyExpenditureInfoDao.class).clone();
        companyExpenditureInfoDaoConfig.initIdentityScope(type);

        companyExpenditureInfoBDaoConfig = daoConfigMap.get(CompanyExpenditureInfoBDao.class).clone();
        companyExpenditureInfoBDaoConfig.initIdentityScope(type);
        ...
        companyPackagingDataInfoDaoConfig = daoConfigMap.get(CompanyPackagingDataInfoDao.class).clone();
        companyPackagingDataInfoDaoConfig.initIdentityScope(type);
        ...
        companyUserInfoBeanDaoConfig = daoConfigMap.get(CompanyUserInfoBeanDao.class).clone();
        companyUserInfoBeanDaoConfig.initIdentityScope(type);
        ...
        companyUserDeleteInfoBeanDaoConfig = daoConfigMap.get(CompanyUserDeleteInfoBeanDao.class).clone();
        companyUserDeleteInfoBeanDaoConfig.initIdentityScope(type);

        dicInfoDaoConfig = daoConfigMap.get(DicInfoDao.class).clone();
        dicInfoDaoConfig.initIdentityScope(type);

        payRecordInfoDaoConfig = daoConfigMap.get(PayRecordInfoDao.class).clone();
        payRecordInfoDaoConfig.initIdentityScope(type);

        roleInfoBeanDaoConfig = daoConfigMap.get(RoleInfoBeanDao.class).clone();
        roleInfoBeanDaoConfig.initIdentityScope(type);
        ...
        companyExpenditureInfoDao = new CompanyExpenditureInfoDao(companyExpenditureInfoDaoConfig, this);
        companyExpenditureInfoBDao = new CompanyExpenditureInfoBDao(companyExpenditureInfoBDaoConfig, this);
        ...
        companyPackagingDataInfoDao = new CompanyPackagingDataInfoDao(companyPackagingDataInfoDaoConfig, this);
        ...
        companyUserInfoBeanDao = new CompanyUserInfoBeanDao(companyUserInfoBeanDaoConfig, this);
        ...
        companyUserDeleteInfoBeanDao = new CompanyUserDeleteInfoBeanDao(companyUserDeleteInfoBeanDaoConfig, this);
        dicInfoDao = new DicInfoDao(dicInfoDaoConfig, this);
        payRecordInfoDao = new PayRecordInfoDao(payRecordInfoDaoConfig, this);
        roleInfoBeanDao = new RoleInfoBeanDao(roleInfoBeanDaoConfig, this);
        ...
        registerDao(CompanyExpenditureInfo.class, companyExpenditureInfoDao);
        registerDao(CompanyExpenditureInfoB.class, companyExpenditureInfoBDao);
        registerDao(CompanyInfo.class, companyInfoDao);
        registerDao(CompanyInventoryInfo.class, companyInventoryInfoDao);
        registerDao(CompanyPackagingDataInfo.class, companyPackagingDataInfoDao);
        ...
        registerDao(CompanyUserInfoBean.class, companyUserInfoBeanDao);
        ...
        registerDao(CompanyUserDeleteInfoBean.class, companyUserDeleteInfoBeanDao);
        registerDao(DicInfo.class, dicInfoDao);
        registerDao(PayRecordInfo.class, payRecordInfoDao);
        registerDao(RoleInfoBean.class, roleInfoBeanDao);
    }
    ...
    public void clear() {
        ...
        companyExpenditureInfoDaoConfig.clearIdentityScope();
        companyExpenditureInfoBDaoConfig.clearIdentityScope();
        companyInfoDaoConfig.clearIdentityScope();
        companyInventoryInfoDaoConfig.clearIdentityScope();
        companyPackagingDataInfoDaoConfig.clearIdentityScope();
        ...
        companyUserInfoBeanDaoConfig.clearIdentityScope();
        ...
        companyUserDeleteInfoBeanDaoConfig.clearIdentityScope();
        dicInfoDaoConfig.clearIdentityScope();
        payRecordInfoDaoConfig.clearIdentityScope();
        roleInfoBeanDaoConfig.clearIdentityScope();
    }
    ...
    public CompanyExpenditureInfoDao getCompanyExpenditureInfoDao() {
        return companyExpenditureInfoDao;
    }

    public CompanyExpenditureInfoBDao getCompanyExpenditureInfoBDao() {
        return companyExpenditureInfoBDao;
    }
    ...
    public CompanyPackagingDataInfoDao getCompanyPackagingDataInfoDao() {
        return companyPackagingDataInfoDao;
    }
    ...
    public CompanyUserInfoBeanDao getCompanyUserInfoBeanDao() {
        return companyUserInfoBeanDao;
    }
    ...
    public CompanyUserDeleteInfoBeanDao getCompanyUserDeleteInfoBeanDao() {
        return companyUserDeleteInfoBeanDao;
    }
    ...
    public PayRecordInfoDao getPayRecordInfoDao() {
        return payRecordInfoDao;
    }

    public RoleInfoBeanDao getRoleInfoBeanDao() {
        return roleInfoBeanDao;
    }
