package com.africa.crm.businessmanagement.baseutil.library.special.view.wheelview;
...
public class WheelView extends View {
    ...
    private void initData(Context context) {
        ...
        shaColor = getContext().getResources().getColor(
                R.color.app_theme_main_color);
    }
    ...
    private void drawItems(Canvas canvas) {
        ...
        // "currentItem"+currentItem+"firstItem"+firstItem);
    ...
    private void drawTopBottomLine(Canvas canvas) {
        ...
        // 创建画笔
        Paint paint = new Paint();
        paint.setColor(shaColor);// 设置线条的红色
