...
/** 
 * DAO for table "COMPANY_DELETE_PURCHASING_ORDER_INFO".
*/
public class CompanyDeletePurchasingOrderInfoDao extends AbstractDao<CompanyDeletePurchasingOrderInfo, Long> {

    public static final String TABLENAME = "COMPANY_DELETE_PURCHASING_ORDER_INFO";

    /**
     * Properties of entity CompanyDeletePurchasingOrderInfo.<br/>
    ...
    public CompanyDeletePurchasingOrderInfoDao(DaoConfig config) {
        super(config);
    }
    
    public CompanyDeletePurchasingOrderInfoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"COMPANY_DELETE_PURCHASING_ORDER_INFO\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"COMPANY_DELETE_PURCHASING_ORDER_INFO\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, CompanyDeletePurchasingOrderInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, CompanyDeletePurchasingOrderInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    public CompanyDeletePurchasingOrderInfo readEntity(Cursor cursor, int offset) {
        CompanyDeletePurchasingOrderInfo entity = new CompanyDeletePurchasingOrderInfo( //
    ...
    @Override
    public void readEntity(Cursor cursor, CompanyDeletePurchasingOrderInfo entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(CompanyDeletePurchasingOrderInfo entity, long rowId) {
        entity.setLocalId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(CompanyDeletePurchasingOrderInfo entity) {
        if(entity != null) {
    ...
    @Override
    public boolean hasKey(CompanyDeletePurchasingOrderInfo entity) {
