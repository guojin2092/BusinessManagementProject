...
/** 
 * DAO for table "COMPANY_DELETE_PAY_ORDER_INFO".
*/
public class CompanyDeletePayOrderInfoDao extends AbstractDao<CompanyDeletePayOrderInfo, Long> {

    public static final String TABLENAME = "COMPANY_DELETE_PAY_ORDER_INFO";

    /**
     * Properties of entity CompanyDeletePayOrderInfo.<br/>
    ...
    public CompanyDeletePayOrderInfoDao(DaoConfig config) {
        super(config);
    }
    
    public CompanyDeletePayOrderInfoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"COMPANY_DELETE_PAY_ORDER_INFO\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"COMPANY_DELETE_PAY_ORDER_INFO\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, CompanyDeletePayOrderInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, CompanyDeletePayOrderInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    public CompanyDeletePayOrderInfo readEntity(Cursor cursor, int offset) {
        CompanyDeletePayOrderInfo entity = new CompanyDeletePayOrderInfo( //
    ...
    @Override
    public void readEntity(Cursor cursor, CompanyDeletePayOrderInfo entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(CompanyDeletePayOrderInfo entity, long rowId) {
        entity.setLocalId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(CompanyDeletePayOrderInfo entity) {
        if(entity != null) {
    ...
    @Override
    public boolean hasKey(CompanyDeletePayOrderInfo entity) {
