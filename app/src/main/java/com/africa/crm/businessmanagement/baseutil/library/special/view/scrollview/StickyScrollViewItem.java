package com.africa.crm.businessmanagement.baseutil.library.special.view.scrollview;
 ...
 */
public class StickyScrollViewItem extends ScrollView {
    ...
    public StickyScrollViewItem(Context context) {
        this(context, null);
    }

    public StickyScrollViewItem(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.scrollViewStyle);
    }

    public StickyScrollViewItem(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void findStickyViews(View v) {
        if (v instanceof ViewGroup) {
            ...
            for (int i = 0; i < vg.getChildCount(); i++) {
                ...
                }else if (vg.getChildAt(i) instanceof ListView) {
                    findStickyViews(vg.getChildAt(i));
                }
            }
        } else {
