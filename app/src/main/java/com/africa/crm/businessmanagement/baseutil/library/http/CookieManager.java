package com.africa.crm.businessmanagement.baseutil.library.http;
...
import com.africa.crm.businessmanagement.baseutil.library.special.ui.user.bean.UserVariable;
...
public class CookieManager {
    ...
    public static void saveCookie(Context context, UserVariable variable) {
        ...
        editor.putString(CookieManager.COOKIEPRE, variable.cookiepre);
        editor.putString(CookieManager.AUTH, variable.auth);
        editor.putString(CookieManager.SALTKEY, variable.saltkey);
        editor.putString(CookieManager.MEMBER_UID, variable.member_uid);
        editor.putString(CookieManager.MEMBER_USERNAME,
                variable.member_username);
		/*editor.putString(CookieManager.GROUPID, variable.groupid);*/
        editor.putString(CookieManager.FORMHASH, variable.formhash);
	/*	editor.putString(CookieManager.ISMODERATOR, variable.ismoderator);
        ...
        editor.putString(CookieManager.QINIU_MALL_TOKEN,
                variable.qiniu_mall_token);
        editor.putString(CookieManager.QINIU_FORUM_TOKEN,
                variable.qiniu_forum_token);
        editor.putString(CookieManager.QINIU_AVATAR_TOKEN,
                variable.qiniu_avatar_token);
        editor.putString(CookieManager.AVATAR_TOKEN_KEY,
    ...
    public static String getCookie(Context context) {
        ...
        SharedPreferences preferences = context.getSharedPreferences(COOKIE, 0);
        if (preferences != null) {
            String cookiePre = preferences.getString(CookieManager.COOKIEPRE,
                    null);
            if (!TextUtils.isEmpty(cookiePre))
                cookie = cookiePre;

            String saltkey = preferences.getString(CookieManager.SALTKEY, null);
            ...
            String auth = preferences.getString(CookieManager.AUTH, null);
