...
/** 
 * DAO for table "COMPANY_DELETE_SERVICE_RECORD_INFO".
*/
public class CompanyDeleteServiceRecordInfoDao extends AbstractDao<CompanyDeleteServiceRecordInfo, Long> {

    public static final String TABLENAME = "COMPANY_DELETE_SERVICE_RECORD_INFO";

    /**
     * Properties of entity CompanyDeleteServiceRecordInfo.<br/>
    ...
    public CompanyDeleteServiceRecordInfoDao(DaoConfig config) {
        super(config);
    }
    
    public CompanyDeleteServiceRecordInfoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"COMPANY_DELETE_SERVICE_RECORD_INFO\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"COMPANY_DELETE_SERVICE_RECORD_INFO\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, CompanyDeleteServiceRecordInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, CompanyDeleteServiceRecordInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    public CompanyDeleteServiceRecordInfo readEntity(Cursor cursor, int offset) {
        CompanyDeleteServiceRecordInfo entity = new CompanyDeleteServiceRecordInfo( //
    ...
    @Override
    public void readEntity(Cursor cursor, CompanyDeleteServiceRecordInfo entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(CompanyDeleteServiceRecordInfo entity, long rowId) {
        entity.setLocalId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(CompanyDeleteServiceRecordInfo entity) {
        if(entity != null) {
    ...
    @Override
    public boolean hasKey(CompanyDeleteServiceRecordInfo entity) {
