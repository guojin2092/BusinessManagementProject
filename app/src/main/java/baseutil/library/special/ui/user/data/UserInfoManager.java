package baseutil.library.special.ui.user.data;

import android.content.Context;
import android.content.SharedPreferences;
import android.content.SharedPreferences.Editor;

import baseutil.library.http.LocalCookieManager;
import baseutil.library.special.ui.user.bean.UserDetailInfoBean;
import baseutil.library.special.ui.user.bean.UserInfoBean;
