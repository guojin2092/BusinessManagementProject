package baselibrary.library.special.ui.user.data;

import android.content.Context;
import android.content.SharedPreferences;
import android.content.SharedPreferences.Editor;

import baselibrary.library.http.LocalCookieManager;
import baselibrary.library.special.ui.user.bean.UserDetailInfoBean;
import baselibrary.library.special.ui.user.bean.UserInfoBean;
