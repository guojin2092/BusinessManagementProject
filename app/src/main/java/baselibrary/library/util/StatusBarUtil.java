...
/**
 * Project：haloproject-android
 * Author:  alex
 * Version: 1.0.0
 * Description：halobear
 * Date：2017/1/6 10:02
...
import baselibrary.library.special.view.StatusBarView;
...
//        setCustomColor(activity, color);
     ...
     * @param color    状态栏颜色值
     */
    public static void setCustomColor(Activity activity, int color) {
