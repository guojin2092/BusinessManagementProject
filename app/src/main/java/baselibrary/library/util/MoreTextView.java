...
//
//import com.simplesoft.resident.R;
//
//
///**
// * 有全文和收起的TextView
...
//     * 默认全文的Text
//     */
//    private static final String EXPANDEDTEXT = "查看更多";
//    /**
//     * 默认收起的text
//     */
...
//     * 查看更多字体大小
//     */
//    private int textSizeOfShowMore;
//    /**
//     * 字体颜色
//     */
...
//        textColor = typedArray.getColor(R.styleable.MoreTextView_textColor, getResources().getColor(R.color.a666666));
//        textSize = typedArray.getDimensionPixelSize(R.styleable.MoreTextView_textSize, 13);
//        textSizeOfShowMore = typedArray.getDimensionPixelSize(R.styleable.MoreTextView_textSize, 12);
...
//                        collapseTextView.setTextSize(textSizeOfShowMore);
//                        collapseTextView.setTextColor(getResources().getColor(R.color.a999999));
//                        collapseTextView.setText(expandedText);
//                        LayoutParams lp = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
//                        lp.setMargins(430, 20, 0, 20);
//                        collapseTextView.setLayoutParams(lp);
//                        collapseTextView.setCompoundDrawables(null, null, getResources().getDrawable(R.drawable.btn_more), null);
