...
import com.infrastructure.base.GridPickerConfigBean;
import com.infrastructure.bean.Entry;
...
public class GridPickerView extends BaseView<List<Entry<Boolean, String>>> {
	 ...
	 * @param lastList
	 */
	public final void init(ArrayList<GridPickerConfigBean> configList, List<Entry<Boolean, String>> lastList, boolean startFirstTab) {
		...
		if(startFirstTab) {
			setView(0, lastList, configList.get(0).getSelectedItemPostion());
		}else {
