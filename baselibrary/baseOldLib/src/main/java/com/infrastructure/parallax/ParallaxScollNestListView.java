 ...
 * 下拉放大图片
 */
public class ParallaxScollNestListView extends NestListView implements OnScrollListener {
    ...
    public ParallaxScollNestListView(Context context, AttributeSet attrs,
                                     int defStyle) {
